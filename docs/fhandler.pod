...
=head1 DESCRIPTION
    ...
    fhandler provides functions that can facilitate file handling.
...
L<dhandler - Directory handling assistant|https://github.com/jangcom/dhandler>

L<tilder - Back up files into respective subdirectories|https://github.com/jangcom/tilder>
